...
class AtomTypeBasedLossMultiplierConfig(ll.TypedConfig):
    freq_ratios_path: Path
    """Number of occurrences of each atom type in the target dataset"""
...
class AtomTypeBasedLossMultiplier(nn.Module):
    atom_type_occurrences: tc.Int[torch.Tensor, "atom_type"]
