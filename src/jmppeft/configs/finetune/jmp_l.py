...
from ...tasks.finetune import FinetuneConfigBase, FinetuneModelBase
...
TModel = TypeVar("TModel", bound=FinetuneModelBase)


@contextlib.contextmanager
def jmp_l_ft_config_builder(
    config_cls: type[TConfig],
    ckpt_path: Path,
    ema_backbone: bool = True,
    disable_force_output_heads: bool = True,
):
    with config_cls.builder() as (builder, config):
