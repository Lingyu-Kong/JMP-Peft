export HF_DATASETS_CACHE="/global/cfs/cdirs/m3641/Nima/hf-datasets-cache"
# in ~/.bashrc, set the env above if you want to change where HF datasets are stored
...
# Install ll
cd ..
git clone https://github.com/nimashoghi/ll.git
cd ll
pip install -e .
