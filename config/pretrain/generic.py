...
def nsys_python_command_prefix(
    ...
    return rf"nsys profile --wait=primary -w true -t cuda,nvtx,osrt,cudnn,cublas -s none -o {str(profiler_directory.absolute())}/nsight_report%q{{SLURM_PROCID}}%q{{SLURM_JOB_ID}}.qdrep -f true -x true "
