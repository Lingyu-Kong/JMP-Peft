...
def get_data(datadir: str, task: str, split: str | None, del_intmd_files: bool) -> None:
    ...
    # If the file has already been downloaded, skip the download step
    if not os.path.exists(os.path.join(datadir, os.path.basename(download_link))):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data-path",
        type=str,
        help="Specify path to save dataset.",
        required=True,
    )
